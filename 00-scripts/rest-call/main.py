...
if __name__ == "__main__":
    ...
    dag_id = "REPLACE_DAG_ID"  # Replace with the ID of the DAG that you want to run.
    ...
    web_server_url = "REPLACE_AIRFLOW_URI"


    response_text = trigger_dag(use_experimental_api=true,
